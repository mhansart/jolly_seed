...
foreach ($tags as $tag) {
    $thisForum .= '<span class="forum-tag">#' . $tag . '</span>';
}
...
foreach ($messages as $message) {
    ...
    $imageResponse = ($tabUser[0]['user_picture'] === "") ? 'public/image/default.png' : 'uploads/' . $tabUser[0]['user_picture'];
    $classMsg = ($message['user_id'] === $forum[0]['user_id']) ? 'voir-plus-quest' : 'voir-plus-response';
    $thisForum .= '
                    <div class="' . $classMsg . ' d-flex">
...
$thisForum .= '
            ...
            <div class="btn-send w-100">
                    <form action="#" method="post" class="d-flex">
                        ...
                        <input type="hidden" name="repondre" value="' . $forum[0]['forum_id'] . '">
