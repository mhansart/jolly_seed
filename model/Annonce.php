<?php 
    ...
    {
        public function create($_ads_type, $_ads_category, $_ads_date, $_ads_description, $_ads_picture, $_ads_active, $_ads_title)
        {
            $requete = "INSERT INTO ads (ads_type, ads_category, ads_date, ads_description, ads_picture, ads_active, ads_title) VALUES (:adsId, :adsType, :adsCategory, :adsDate, :adsDescription, :adsPicture, :adsActive, :adsTitle)";
